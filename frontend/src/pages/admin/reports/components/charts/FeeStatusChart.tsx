...
export function FeeStatusChart({ data }: { data: CategorySlice[] }) {
    ...
    <div>
      <ResponsiveContainer width="100%" height={196}>
        <PieChart>
          ...
          <Pie data={data} dataKey="value" nameKey="label" innerRadius={0} outerRadius={80} paddingAngle={2} isAnimationActive={false} label={renderLabel} labelLine={false}>
            {data.map((entry, i) => (
